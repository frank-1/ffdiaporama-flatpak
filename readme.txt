Source files organisation
    ...
    File starting with cCustom are custom GUI override
    File starting with wgt_ are widget definitions
    File starting with Dlg are Dialog Box definitions


    _GlobalDefines.h is the first file to include and it's including in all .h files
        It contains :
    ...
    _ApplicationDefinitions.h/.cpp contains basic objects for application manipulation like
        - Application preferences
        - Wrapper for application setting file
        Normally, _ApplicationDefinitions is not included except in basic data file

    _ImagesDefinitions.h/.cpp contains basic objects for image manipulation like
        - Images filters (transform and correction)
        - Brush objects
        - Backgroung objects
        - Icon objects
        - Luma objects
        Normally, _ImagesDefinitions is not included except in basic data file

    _SoundDefinitions.h/.cpp contains basic objects for sound manipulation like
        - SoundBlockList object (list of basic sound packet)
        - MusicObject (music file wrapper for .wav/.mp3/.ogg/...)
        Normally, _SoundDefinitions is not included except in basic data file

    _ImageFileWrapper.h/.cpp contains the image file wrapper (for .jpg/.png/...)
        Normally, _ImageFileWrapper is not included except in basic data file

    _VideoFileWrapper.h/.cpp contains the video file wrapper (for .avi/.mp4/...)
        Normally, _VideoFileWrapper is not included except in basic data file
