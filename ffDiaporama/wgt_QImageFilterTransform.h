...
class wgt_QImageFilterTransform : public QWidget {
Q_OBJECT
public:
    ...
    explicit wgt_QImageFilterTransform(QWidget *parent = 0);
    ~wgt_QImageFilterTransform();

    void    SetFilter(cFilterTransformObject *Filter,cDiaporamaObject *DiaporamaObject);
...
private:
    Ui::wgt_QImageFilterTransform *ui;
};

#endif // wgt_QImageFilterTransform_H
