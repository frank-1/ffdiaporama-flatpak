...
QStringList cBaseApplicationConfig::LoadBrowserFavoritesFromDabase() {
    QString     TextValue;
    QStringList BrowserFavorites;
    qlonglong   Nbr=0;
...
void cBaseApplicationConfig::SaveBrowserFavoritesToDabase(QStringList BrowserFavorites) {
    QDomDocument    DomDocument;
