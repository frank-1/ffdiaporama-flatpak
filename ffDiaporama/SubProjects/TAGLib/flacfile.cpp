...
#include "tbytevector.h"   // Change by Dominique Levray : "tbytevector.h" instead of <tbytevector.h>
#include "tstring.h"       // Change by Dominique Levray : "tstring.h" instead of <tstring.h>
#include "tlist.h"         // Change by Dominique Levray : "tlist.h" instead of <tlist.h>
#include "tdebug.h"        // Change by Dominique Levray : "tdebug.h" instead of <tdebug.h>
#include "tagunion.h"      // Change by Dominique Levray : "tagunion.h" instead of <tagunion.h>
#include "id3v2header.h"   // Change by Dominique Levray : "id3v2header.h" instead of <id3v2header.h>
#include "id3v2tag.h"      // Change by Dominique Levray : "id3v2tag.h" instead of <id3v2tag.h>
#include "id3v1tag.h"      // Change by Dominique Levray : "id3v1tag.h" instead of <id3v1tag.h>
#include "xiphcomment.h"   // Change by Dominique Levray : "xiphcomment.h" instead of <xiphcomment.h>
