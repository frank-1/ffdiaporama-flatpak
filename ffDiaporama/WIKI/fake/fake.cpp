void Append() {
	...
	Str=QApplication::translate("0010","Welcome to the ffDiaporama WIKI");
	Str=QApplication::translate("0010","This WIKI is being restructured. Now, information about dialog boxes appear directly in the dialog boxes as ToolTips (leave the mouse a few seconds on a zone displays information on the zone).");
	Str=QApplication::translate("0010","How ffDiaporama works");
	...
	Str=QApplication::translate("0015","All shots regulations versus current shot regulations");
	Str=QApplication::translate("0015","There are two types of settings in the 'Image framing and corrections' dialog:");
	...
	Str=QApplication::translate("0015","<B>The settings which apply to all shots.</B> These settings are made globally, that is their effects will be visible on all the shots of the slide. Here are some some: ");
	Str=QApplication::translate("0015","Equalize (Filter of type Equalization of histogram)");
	Str=QApplication::translate("0015","De-speckle (Filter of type Reduction of noise)");
	Str=QApplication::translate("0015","Levels of grey (Passage in black and white)");
	Str=QApplication::translate("0015","Blur/Sharpen");
	Str=QApplication::translate("0015","etc...");
	...
	Str=QApplication::translate("0020","Welcome to the ffDiaporama WIKI");
	Str=QApplication::translate("0020","This WIKI is being restructured. Now, information about dialog boxes appear directly in the dialog boxes as ToolTips (leave the mouse a few seconds on a zone displays information on the zone).");
	Str=QApplication::translate("0020","Interface description");
	...
	Str=QApplication::translate("0022","Allows you to create a new blank project using the default project settings as defined in the Application settings. ");
	...
	Str=QApplication::translate("0022","Allows you to save the current project in a different file.");
	Str=QApplication::translate("0022","The file selection dialog appears and allows you to select a destination file.");
	Str=QApplication::translate("0022","Project properties");
	Str=QApplication::translate("0022","Allows you to open the project properties dialog");
	Str=QApplication::translate("0022","Settings");
	Str=QApplication::translate("0022","Allows you to define applications settings.");
	Str=QApplication::translate("0022","The Application settings dialog appears.");
	...
	Str=QApplication::translate("0022","Allows you to add an empty slide : the slide is appended to the project and is displayed in the timeline.");
	Str=QApplication::translate("0022","Add files");
	Str=QApplication::translate("0022","INS");
	Str=QApplication::translate("0022","Allows you to add photo or video files : A file selection dialog appears and allows you to select one or more files. ");
	Str=QApplication::translate("0022","Note: Each file selected is added to the project alphabetically by filename or in the numerical order of shots. ");
	Str=QApplication::translate("0022","Cameras number pictures/video sequences as they are taken; using numerical order ensures the correct chronological order of shots.");
	Str=QApplication::translate("0022","Add project");
	Str=QApplication::translate("0022","Allows you to add the slides of an existing project to the end the current project: a file selection dialog appears and allows you to select a project file. Slides, slide settings, music and background of the project are added to the current project.");
	Str=QApplication::translate("0022","Cut");
	Str=QApplication::translate("0022","CTRL+X");
	Str=QApplication::translate("0022","Allows you to cut the current slide (remove it from the timeline and put it in the clipboard).");
	...
	Str=QApplication::translate("0022","Allows you to paste the slide currently in the clipboard into the timeline.");
	...
	Str=QApplication::translate("0022","Background property (Equivalent to a double click on the background track)");
	Str=QApplication::translate("0022","F6");
	Str=QApplication::translate("0022","Slide property (Equivalent to a double click on the mounting track)");
	Str=QApplication::translate("0022","F7");
	Str=QApplication::translate("0022","Music property (Equivalent to a double click on the music track)");
	Str=QApplication::translate("0022","F8");
	Str=QApplication::translate("0022","Open transition property (Equivalent to a double click on the transition)");
	...
	Str=QApplication::translate("0022","It is possible to add slides by Drag and Drop directly using the file browser. Drag photos or videos onto the timeline and slides are created at the point you release the files.");
	...
	Str=QApplication::translate("0022","The Render movie dialog from database appears.");
	...
	Str=QApplication::translate("0022","Allows you to render the video in a lossless format. Lossless format is not destructive, so it is possible to render several times the same video without losing in quality.");
	Str=QApplication::translate("0022","The Render movie dialog appears.");
	Str=QApplication::translate("0022","Advanced");
	Str=QApplication::translate("0022","Allows you to render the video using the Advanced render video dialog.");
	...
	Str=QApplication::translate("0023","To modify the slide (framing, filter, animation, etc.) double-click the thumbnail. This action opens the <a href=\"0119.html\">Modify slides</a> dialog.");
	...
	Str=QApplication::translate("0030","Welcome to the ffDiaporama WIKI");
	Str=QApplication::translate("0030","This WIKI is being restructured. Now, information about dialog boxes appear directly in the dialog boxes as ToolTips (leave the mouse a few seconds on a zone displays information on the zone).");
	Str=QApplication::translate("0030","Rendering videos");
	Str=QApplication::translate("0030","Rendering videos");
	...
	Str=QApplication::translate("0036","Note : ffDiaporama uses the standard x264 fast preset.");
	...
	Str=QApplication::translate("0040","Welcome to the ffDiaporama WIKI");
	Str=QApplication::translate("0040","This WIKI is being restructured. Now, information about dialog boxes appear directly in the dialog boxes as ToolTips (leave the mouse a few seconds on a zone displays information on the zone).");
	Str=QApplication::translate("0040","Technical information on ffDiaporama");
	...
	Str=QApplication::translate("0043","The configuration files for ffDiaporama");
	Str=QApplication::translate("0043"," In order to work, the application needs two configuration files. Each of them consists of a pair of files. ");
	...
	Str=QApplication::translate("0043"," When the application is launched for the first time, the user configuration file is created if it does not already exist. ");
	Str=QApplication::translate("0043","Remark: ");
	Str=QApplication::translate("0043","If ffDiaporama is used by several users on the same PC, there will be a separate configuration file for each user.");
	Str=QApplication::translate("0043"," The same principle is used for 2 files: ");
	...
	Str=QApplication::translate("0101","Application options dialog");
	Str=QApplication::translate("0101","This dialog box allows you to define options for the application.");
	Str=QApplication::translate("0101","It consists of following 3 tabs:");
	...
	Str=QApplication::translate("0101","Defines the quantity of memory used as cache memory by ffDiaporama. This parameter is important because it allows to adapt ffDiapora to your hardware.");
	...
	Str=QApplication::translate("0101","Remark: This effect consumes lots of resources and can result in slow preview on small machines. Unchecking this box allows then to keep a fluid preview.");
	...
	Str=QApplication::translate("0101","Multiple file insertion");
	Str=QApplication::translate("0101","This option allows you to adjust the way files are sorted when you select several files in <I><B>Add file</B></I>. ");
	Str=QApplication::translate("0101","If this box is checked, files will be added in order of their numerical suffix : Example: if you select IMG_0025, IMG_0032, MVI_0029 and MVI_0040, the files will be inserted as follows : IMG_0025, MVI_0029, IMG_0032 and MVI_0040");
	Str=QApplication::translate("0101","If this box is unchecked, files are added in alphabetical order.");
	...
	Str=QApplication::translate("0101","Video");
	...
	Str=QApplication::translate("0101"," Note: this field is limited to 30 characters to remain compatible with jukebox");
	Str=QApplication::translate("0101","Author");
	Str=QApplication::translate("0101","Defines the default value for the field Author (often so called Artist by Jukebox) ");
	Str=QApplication::translate("0101","Note: this field is limited to 30 characters to remain compatible with jukebox");
	...
	Str=QApplication::translate("0101","Shape");
	Str=QApplication::translate("0101","Allows to select the style of the shape applied to the new text blocks. This style defines the shape (rectangle, circle, …), the border, the opaqueness and the shadow effect applied to the block.");
	...
	Str=QApplication::translate("0101","At the bottom of the dialog the two buttons allow you to:");
	...
	Str=QApplication::translate("0103","Add or modify a predefined title slide");
	Str=QApplication::translate("0103","This dialog allows you to select a model and define chapter information for this predefined slide.");
	...
	Str=QApplication::translate("0108","The properties of the project are a partial implementation of the MPEG-7 standard on the descriptors of multimedia contents.");
	Str=QApplication::translate("0108","These properties are written into the video files during the rendering and can be exploited by indexing systems (collection managers) or by jukeboxes.");
	...
	Str=QApplication::translate("0108","Remark: This field is only editable when the dialog box is used for creating a new project. Subsequently, it is not possible to change this value.");
	Str=QApplication::translate("0108","Title");
	Str=QApplication::translate("0108","The title of the project (For more compatibility with the standard id3v2, this fields is limited to 30 characters)");
	Str=QApplication::translate("0108","Author");
	Str=QApplication::translate("0108","The name of the author of the project (For more compatibility with the standard id3v2, this fields is limited to 30 characters) ");
	Str=QApplication::translate("0108","Remark: This field is often shown by indexing system and jukeboxes under the term Artist");
	Str=QApplication::translate("0108","Album");
	Str=QApplication::translate("0108","The album of the project (For more compatibility with the standard id3v2, this fields is limited to 30 characters)");
	Str=QApplication::translate("0108","Year");
	Str=QApplication::translate("0108","Year (4 numbers) ");
	Str=QApplication::translate("0108","Remark: This field is different from \"timestamp\" field");
	Str=QApplication::translate("0108","Language");
	Str=QApplication::translate("0108","The language of the audio track (ISO 639 standard - 3 characters)");
	...
	Str=QApplication::translate("0108","Remark: numerous indexing systems or jukeboxes will read only the 1st line.");
	Str=QApplication::translate("0108","Remarks:");
	...
	Str=QApplication::translate("0108","For more compatibility with indexing systems and jukeboxes, ffDiaporama does not include the whole video TAGs but is closer rather to the standard id3v2 than is the most used by these systems today. Furthermore, the video formats do not support every TAG in the same way.");
	Str=QApplication::translate("0108","Chapters");
	Str=QApplication::translate("0108"," Chapters defined in the project are listed for consultation. (To modify chapters use Chapter button in modify slide dialog.) ");
	...
	Str=QApplication::translate("0110","Framing");
	...
	Str=QApplication::translate("0110","Alternatively, you can use the interactive zone to set the framing with the mouse or the keyboard. ");
	...
	Str=QApplication::translate("0110","Image corrections");
	...
	Str=QApplication::translate("0110","The following buttons help you in image settings: ");
	...
	Str=QApplication::translate("0110","Remarks");
	Str=QApplication::translate("0110","All the combinations are possible. For example: you can increase the red and reduce the green at the same time.");
	Str=QApplication::translate("0110","The results depend on the initial strength of the primary color components of the source image.");
	Str=QApplication::translate("0110"," This button allows the value to be reset to zero for all correction settings.");
	Str=QApplication::translate("0110","Image transformations");
	Str=QApplication::translate("0110"," Apply a filter to the photo or video images. ");
	Str=QApplication::translate("0110","The following filters are available: ");
	Str=QApplication::translate("0110","Equalize (Histogram equalization)");
	Str=QApplication::translate("0110","Despeckle (Noise reduction)");
	Str=QApplication::translate("0110","Gray (black & white)");
	...
	Str=QApplication::translate("0110","The blue part represents the part of the video which is selected (which will be used in the assembly).");
	...
	Str=QApplication::translate("0111","#");
	...
	Str=QApplication::translate("0112","Manage favorite");
	Str=QApplication::translate("0112","Manage favorite");
	...
	Str=QApplication::translate("0114","Available settings for the music track");
	Str=QApplication::translate("0114","Continue current playlist");
	Str=QApplication::translate("0114","Continues to play the play list defined by a previous slide:");
	...
	Str=QApplication::translate("0114","Specifies that from now on, the sound volume is reduced. This option is particularly useful, for example, to reduce the sound of the music during the play of a video. Remark : This volume reduction is applied only for the selected slide.");
	Str=QApplication::translate("0114","Set to pause");
	Str=QApplication::translate("0114","Pauses the current play list. Remark : This pause is applied only for the selected slide.");
	...
	Str=QApplication::translate("0114","Removes the current selected file from the playlist.");
	...
	Str=QApplication::translate("0114","The music files are listed in the order in which they will be played, from top to bottom. The Volume column defines the \" Master volume \" for the file. This volume is independent of any reductions in the volume that you define in the upper part of the dialog.");
	...
	Str=QApplication::translate("0115","This dialog has 3 different appearances depending on whether you clicked the Device type, Lossless or the Advanced button. ");
	Str=QApplication::translate("0115","Description of the dialog box");
	Str=QApplication::translate("0115","In device mode and in advanced mode");
	...
	Str=QApplication::translate("0115","At the dialog bottom: The properties button");
	Str=QApplication::translate("0115","This button allows you to open project properties dialog. It allows you to adjust the properties before generating the video.");
	Str=QApplication::translate("0115","Note: the project properties are saved into the video as TAG (METADATA) which are used by a lot of indexing programs or by jukeboxes.");
	...
	Str=QApplication::translate("0115","See also");
	Str=QApplication::translate("0115","ISO 639");
	...
	Str=QApplication::translate("0119","Slide properties");
	Str=QApplication::translate("0119","This dialog allows you to define settings for the slides.");
	Str=QApplication::translate("0119","This dialog includes numerous zones: ");
	...
	Str=QApplication::translate("0119","Place the mouse over each area for more information.");
	...
	Str=QApplication::translate("0119","It is also possible to open contextual menus by right clicking on zones. Each of these menus propose commands which depend on what you have clicked. ");
	Str=QApplication::translate("0119","Command");
	Str=QApplication::translate("0119","Contextual menu");
	...
	Str=QApplication::translate("0119","Add a new title block");
	Str=QApplication::translate("0119","Right click on blocks table or on interactive zone when no block was selected");
	Str=QApplication::translate("0119","Add one or several new blocks of images or video. A file selection dialog appears allowing you to select files. Note: in case of multiple selection, files are added in the alphabetical order of the filenames or in the digital order of shots (according to the option selected in the configuration dialog).");
	...
	Str=QApplication::translate("0119","Right click on blocks table or on interactive zone");
	...
	Str=QApplication::translate("0119","Paste block from the ffDiaporama clipboard and insert it to the end of the block table");
	...
	Str=QApplication::translate("0119","Lock or unlock properties of active block. (See: <a href=\"#LockProperties\">Block properties locking</a>)");
	...
	Str=QApplication::translate("0119","Remark: The selected blocks are aligned with the rectangle containing them. So, an alignment to the center will align blocks to the center of the selection rectangle.");
	...
	Str=QApplication::translate("0119","Chapter");
	Str=QApplication::translate("0119","If this box is checked, the slide will mark the beginning of a new chapter.");
	Str=QApplication::translate("0119","Remarks: The name of the chapter will be the name of the slide");
	Str=QApplication::translate("0119","With the exception of the 1st chapter of the video which cannot be deactivated, is always positioned on the 1st slide and always begins at 0, chapters begin after the enterring transition.");
	...
	Str=QApplication::translate("0119"," If the properties of the block are locked during this shot. (This information does not appear for the 1st plan.)");
	Str=QApplication::translate("0119"," If the properties of the block are unlocked during this shot. (This information does not appear for the 1st plan.)");
	...
	Str=QApplication::translate("0119","This settings group deals with style management. For more information on style management, see : Using style management");
	...
	Str=QApplication::translate("0119","Remark: To change the velocity curve for image animation (graphic effect and framing), edit the image or video and select a velocity in the Image framing and correction dialog");
	...
	Str=QApplication::translate("0119","Block properties locking");
	Str=QApplication::translate("0119"," When the block properties are locked, the modifications made to the block in the preceding shot are echoed in the current shot. ");
	Str=QApplication::translate("0119","It defines as well the coordinates, forms and animations properties as the properties defined in the editing dialog of text, image or video. ");
	Str=QApplication::translate("0119","Remark:");
	Str=QApplication::translate("0119","The properties locking is available only from the 2nd shot.");
	...
	Str=QApplication::translate("main","Welcome to the ffDiaporama WIKI");
	Str=QApplication::translate("main","This WIKI is being restructured. Now, information about dialog boxes appear directly in the dialog boxes as ToolTips (leave the mouse a few seconds on a zone displays information on the zone).");
	Str=QApplication::translate("main","Index");
