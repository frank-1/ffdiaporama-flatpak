...
su -c "yum install qt4-devel qt-webkit-devel ffmpeg-devel SDL-devel SDL_mixer-devel rpmdevtools yum-utils rpmlint"
su -c "yum install qt4 qt-webkit ffmpeg SDL SDL_mixer exiv2"
