...
Inquadratura:</translation>
    ...
    <message>
        ...
        <translation>La scheda opzioni applicazione permette di definire il comportamento generale di ffDiaporama.</translation>
    </message>
    <message>
...
- If Append to the end of the project is selected, then the new slides will be created at the end of the project.</source>
        <translation>Questa opzione permette di aggiustare la posizione occupata dal nuovo oggetto inserito all&apos;interno della linea temporale.
-.Se si seleziona inserisci dopo l&apos;oggetto selezionato corrente, le nuove diapositive saranno create dopo la diapositiva corrente.
...
Nota: Alcuni produttori producono video FullHD 1920 × 1088 invece di 1920 × 1080. Lo fanno per accelerare la codifica, che è più veloce, con un multiplo di 16 linee. Ma questa dimensione non è 16:9. Per mantenere l&apos;intera immagine, non solo l&apos;immagine viene deformata per adattarsi allo schermo ma appaiono sui lati bande nere. Per evitare tutti questi problemi, selezionando questa casella, questi video sono troncati per restituire una dimensione di 1920 × 1080. Poi 4 linee sono tagliate in alto e in basso.</translation>
    </message>
    <message>
...
Remark: This effect consumes lots of resources and can result in slow preview on small machines. Unchecking this box allows then to keep a fluid preview.</source>
        <translation>Se questa casella è selezionata, l&apos;effetto levigatura immagine verrà applicato alle immagini durante l&apos;anteprima.
Nota: Questo effetto consuma molte risorse e può portare ad una anteprima lenta su piccole macchine. Se si deseleziona la casella permette quindi di mantenere una anteprima fluida.</translation>
    </message>
    <message>
 ...
 - Pixel: Coordinates (X, Y, Width and Height) are expressed in pixels relative to a screen in 1080p mode</source>
        <translation>Questa opzione permette di selezionare l&apos;unità per le coordinate che verrà utilizzato nella finestra di proprietà.
Si può scegliere:
 - Percentuale: Coordinate (X, Y, larghezza e altezza) sono espresse in percentuali
 - Pixel: Coordinate (X, Y, larghezza e altezza) sono espresse in pixel relativi ad una schermata in modalità 1080p</translation>
    </message>
    <message>
...
Remark: Some manufacturers produce videos using interlaced mode. They make it to accelerate the encoding. The problem is it deforms the image on which moved lines appear. For more information on interlaced video, see Wikipedia page on interlaced video.</source>
        <translation>Se il filtro Attiva deinterlacciamento quando si aggiungono nuovi video MTS è selezionato, il filtro di deinterlacciamento viene automaticamente attivato per tutti i video .Mts aggiunti al progetto.
Nota: Alcuni produttori producono video utilizzando la modalità interlacciata. Lo fanno per accelerare la codifica. Il problema è che deforma l&apos;immagine su cui appaiono le linee spostate. Per maggiori informazioni sul video interlacciato, vedi la pagina Wikipedia sul video interlacciato.</translation>
    </message>
    <message>
...
Note: the higher this number, the more smooth the preview will be. On the other hand, more computer resources will be required. Reduce this number on slow computers or if the gauge for your multimedia reader is frequently in the red zone.</source>
        <translation>Definisce il numero di immagini al secondo che saranno generati per mostrare l&apos;anteprima.
Nota: più alto è questo numero, più agevole sarà l&apos;anteprima. D&apos;altra parte, saranno necessarie più risorse del computer. Ridurre questo numero su computer lenti o se l&apos;indicatore nel lettore multimediale è spesso nella zona rossa.</translation>
    </message>
    <message>
...
The &quot;raster&quot; Graphics accelerates the display but can raise problems on some computer in particular with KDE.</source>
        <translation>Se questa casella è selezionata, il sistema grafico &quot;raster&quot; è usato al posto del sistema grafico di default. Questa opzione viene utilizzata solo in caso di applicazione all&apos;avvio.

La grafica &quot;raster&quot; accelera il display ma può sollevare problemi su qualche computer in particolare con KDE.</translation>
    </message>
    <message>
...
- Se questa casella non è selezionata, i file vengono aggiunti in ordine alfabetico.</translation>
    ...
    <message>
        ...
        <translation>La scheda Opzioni di progetto permette di definire le opzioni di default del progetto in corso e per i nuovi progetti.</translation>
    </message>
    <message>
        <source>Sets the default speed curve for the blocks animations of new projects</source>
        <translation>Imposta la curva di velocità predefinita per i blocchi animazione dei nuovi progetti</translation>
    </message>
    <message>
...
- Lock to project geometry: The shape of the block has the same shape as the image</source>
        <translation>Permette di selezionare il vincolo geometrico applicato ai nuovi blocchi di testo.
- Sblocca: La forma del blocco è libero
- Bloccare alla geometria progetto: La forma del blocco ha la stessa forma l&apos;immagine</translation>
    </message>
    <message>
...
Note: the geometry of a project is defined once and for all when it is created. It is not possible to modify it afterwards.</source>
        <translation>Seleziona la geometria immagine da utilizzare per la creazione di progetti. Tre geometrie sono disponibili:
- 4:3: Corrisponde ad un vecchio televisore con (quasi) schermo quadrato
- 16:9: Corrisponde a un televisore moderno con schermo rettangolare
- 2.35:1: corrisponde al formato del Cinema (su un televisore, questo formato utilizza le strisce nere in alto e in basso.

Nota: la geometria di un progetto è definita una volta per tutte al momento della creazione. Non è possibile modificarla in seguito.</translation>
    </message>
    <message>
        <source>Sets the default speed curve for the image effects animations of new projects</source>
        <translation>Imposta la curva di velocità predefinita per gli effetti di animazione immagine dei nuovi progetti</translation>
    </message>
    <message>
...
This style defines the size, the coordinates, the rotations and the geometrical constraint.</source>
        <translation>Permette di selezionare, per ogni geometria di progetto, lo stile applicato ai nuovi blocchi di testo.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Stili di inquadratura definiscono come ritagliare l&apos;immagine per renderla compatibile con il blocco in cui viene visualizzata.</translation>
    </message>
    <message>
        ...
        <translation>Gli stili di posizione definiscono le dimensioni, coordinate, rotazioni e vincolo geometrico da applicare ai blocchi.</translation>
    </message>
    <message>
...
Remark: This setting apply to all image formats.</source>
        <translation>Permette di selezionare lo stile di caratteri applicato al testo dei blocchi.
...
Questo stile definisce la forma (rettangolo, cerchio, ...), il confine, l&apos;opacità e l&apos;effetto ombra applicato al blocco.
Nota: Questa impostazione si applica a tutti i formati di immagine.</translation>
    </message>
    <message>
...
This style defines the font, its size, its color and the shadow effects applied to the text.</source>
        <translation>Permette di selezionare lo stile di caratteri applicato ai nuovi blocchi di testo.
Questo stile definisce il tipo di carattere, la dimensione, il colore e gli effetti d&apos;ombra applicati al testo.</translation>
    </message>
    <message>
...
This style defines the shape (rectangle, circle, …), the border, the opaqueness and the shadow effect applied to the block.</source>
        <translation>Permette di selezionare lo stile della forma applicata ai nuovi blocchi di testo.
Questo stile definisce la forma (rettangolo, cerchio, ...), il confine, l&apos;opacità e l&apos;effetto ombra applicato al blocco.</translation>
    </message>
    <message>
...
This style defines the transparency of the block and its filling.</source>
        <translation>Permette di selezionare lo stile di sfondo applicato ai nuovi blocchi di testo.
Questo stile definisce la trasparenza del blocco e il suo riempimento.</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Questo gruppo di impostazioni applica ai nuovi blocchi di testo creati nella finestra diapositiva mediante il &lt;img src=&quot;:/img/add_text.png&quot;/&gt;  pulsante.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <source>Default options for new text block</source>
        <translation>Opzioni predefinite per nuovo blocco di testo</translation>
    </message>
    <message>
        <source>Default options for new image or video block (when adding block in slide dialog)</source>
        <translation>Opzioni predefinite per i nuovi blocchi immagine o video (quando si aggiungono blocco finestra scorrevoli)</translation>
    </message>
    <message>
        <source>The Rendering options Tab allows to define the options used by default during the generation of videos.</source>
        <translation>Il scheda Opzioni rendering consente di definire le opzioni utilizzate di default durante la generazione di video.</translation>
    </message>
    <message>
...
Use title project as video name: Use the title defined in the project properties as the name of video</source>
        <translation>Questa opzione permette di selezionare il nome che sarà proposto come impostazione predefinita durante il rendering dei video.
Questa opzione può essere applicata solo se il progetto è stato salvato in un primo momento.

Utilizzare il nome del progetto come nome del video: se il nome del progetto è Assembla.ffd, poi Assembla sarà il nome proposto

Utilizzare il nome della cartella del progetto come nome del video: se il nome del progetto e Assembla.ffd e viene salvato nella directory Mie vacanze 2011, poi mie vacanze 2011 sarà il nome proposto

Utilizzare titolo progetto come nome video: Utilizzare il titolo definito nelle proprietà del progetto, come il nome del video</translation>
    </message>
    <message>
        <source>Select the default frequency to use for audio during the rendering.</source>
        <translation>Selezionare la frequenza di default da utilizzare per l&apos;audio durante il rendering.</translation>
    </message>
    <message>
...
- The Rendering options Tab allows to define the options used by default during the generation of videos.</source>
        <translation>Questa finestra di dialogo consente di definire le opzioni per l&apos;applicazione.
Presenta le seguenti tre schede:
- La scheda Opzioni applicazione permette di definire il comportamento generale di ffDiaporama.
- La scheda Opzioni di progetto permette di definire le opzioni di default del progetto in corso e per i nuovi progetti.
- La scheda Opzioni di rendering consente di definire le opzioni utilizzate per impostazione predefinita durante la generazione di video.</translation>
    </message>
    <message>
        <source>Allows you to open the Check configuration dialog box</source>
        <translation>Consente di aprire la finestra di dialogo di Verifica configurazione</translation>
    </message>
    <message>
        <source>Allows you to open the Manage device dialog box</source>
        <translation>Consente di aprire la finestra di dialogo Gestisci dispositivo</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Questo gruppo di impostazioni applica ai nuovi blocchi di immagine o video creati nella finestra diapositiva mediante il &lt;img src=&quot;:/img/add_image.png&quot;/&gt;pulsante. &lt;br/&gt;&lt;br/&gt;Per ogni formato di immagine e ogni geometria di progetto selezionare lo stile di posizione per applicarlo ai nuovi blocchi. &lt;br/&gt;- Stili di inquadratura definiscono come ritagliare l&apos;immagine per renderla compatibile con il blocco in cui viene visualizzata.. &lt;br/&gt;-Gli stili di posizione definiscono le dimensioni, coordinate, rotazioni e vincolo geometrico da applicare ai blocchi.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
...
Note: this field is limited to 30 characters to remain compatible with jukebox</source>
        <translation>Definisce il metodo di riempimento automatico da utilizzare per le proprietà di progetto del titolo:
- No riempimento automatico: Si dovrà definire manualmente il titolo
- Riempire con il nome del progetto quando il progetto viene salvato : il titolo avrà lo stesso nome del file .ffd
- Riempire con il nome della cartella di progetto quando il progetto viene salvato : il titolo avrà lo stesso nome della cartella in cui il file .ffd  viene salvato

Nota: questo campo è limitato a 30 caratteri per rimanere compatibile con jukebox
</translation>
    </message>
    <message>
...
- If no previous slide has a background definition, then a black frame will be used.</source>
        <translation>Se questa opzione è selezionata, la slitta non avrà alcuno sfondo definito ma utilizzerà lo stesso sfondo della diapositiva precedente:
- Se la diapositiva precedente non ha uno sfondo definito, la verifica continua all&apos;indietro fino a una diapositiva trovata che ha uno sfondo definito.
- Se nessuna diapositiva precedente ha uno sfondo definito, allora verrà utilizzata una cornice nera.</translation>
    </message>
    <message>
        <source>If this option is selected, the slide will have its own background definition.</source>
        <translation>Se questa opzione è selezionata, la diapositiva avrà una proprio sfondo definito.</translation>
    </message>
    <message>
        <source>Allows you to select an image.</source>
        <translation>Consente di selezionare un&apos;immagine.</translation>
    </message>
    <message>
...
- Image disk: Allow to select a photo or an image from a file on the disk.</source>
        <translation>Consente di selezionare un tipo di pennello del seguente elenco:
- Pennello solido: permette di selezionare un colore chiaro.
- Gradiente 2 colori: consente di scegliere un gradiente tra 2 colori
- Gradiente 3 colori: consente di scegliere un gradiente tra 3 colori
- Immagine da biblioteca: Permette di selezionare uno sfondo predefinito
- Immagine del disco: permette di selezionare una foto o un&apos;immagine da un file sul disco.</translation>
    </message>
    <message>
        ...
        <translation>Se questa casella è selezionata, l&apos;immagine non si deforma e si può aprire la finestra di framing immagine per selezionare una parte dell&apos;immagine.</translation>
    </message>
    <message>
        <source>Opens the Image framing dialog to select a part of the image.</source>
        <translation>Apre la finestra di framing immagine per selezionare una parte dell&apos;immagine.</translation>
    </message>
    <message>
        <source>Allows you to select the gradient orientation.</source>
        <translation>Consente di selezionare l&apos;orientamento del gradiente.</translation>
    </message>
    <message>
        <source>Allows you to define the position (in percentage) of the 3rd gradient color.</source>
        <translation>Consente di definire la posizione (in percentuale) del 3° colore gradiente.</translation>
    </message>
    <message>
        <source>Allows you to select the first color.</source>
        <translation>Consente di selezionare il primo colore.</translation>
    </message>
    <message>
        <source>Allows you to select the second color.</source>
        <translation>Consente di selezionare il secondo colore.</translation>
    </message>
    <message>
        <source>Allows you to select the last color.</source>
        <translation>Consente di selezionare l&apos;ultimo colore.</translation>
    </message>
    <message>
        <source>If this box is checked, the image fills the screen, even if it has to be deformed.</source>
        <translation>Se questa casella è selezionata, l&apos;immagine riempie lo schermo, anche se deve essere deformata.</translation>
    </message>
    <message>
        <source>Allows you to select a photo or an image from a file on the disk.</source>
        <translation>Consente di selezionare una foto o un&apos;immagine da un file sul disco.</translation>
    </message>
    <message>
        <source>The &quot;Background properties&quot; dialog allows you to define settings for the background of the slide.</source>
        <translation>La finestra &quot;Proprietà sfondo&quot; consente di definire le impostazioni per lo sfondo della diapositiva.</translation>
    </message>
    <message>
        <source>Accept modification and exit dialog box</source>
        <translation>Accetta le modifiche e esci dalla finestra di dialogo</translation>
...
- For a library: The version is old</source>
        <translation>Qui sono elencati i componenti utilizzati e il loro stato:

Rosso: Il componente non funziona correttamente

Verde: il componente funziona correttamente

Giallo: il componente funziona parzialmente
- Per un codec: Solo la lettura è disponibile (non la codifica)
- Per una libreria: La versione è vecchia</translation>
    </message>
    <message>
...
To solve the problems you will have to install additional packages on your computer then make ffDiaporama from source and verify again the configuration.</source>
        <translation>Questa finestra di dialogo consente di controllare la configurazione degli strumenti esterni e librerie usate da ffDiaporama.
E &apos;particolarmente utile per gli utenti Linux e per chi compila l&apos;applicazione.
Gli errori più comuni riportati riguardano le versioni dei formati supportati, codec e librerie.

Per risolvere i problemi si dovranno installare i pacchetti aggiuntivi sul vostro computer poi compilare ffDiaporama dai sorgenti e verificare nuovamente la configurazione.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>La data e l&apos;ora di creazione del file sul disco (quando si è trasferito nella telecamera).</translation>
    </message>
    <message>
        ...
        <translation>La data e l&apos;ora dell&apos;ultima modifica del file (quando la foto è stata scattata o quando si è modificato con un editor di immagini).</translation>
    </message>
    <message>
        <source>This dialog allows to obtain detailed information on a multimedia file.</source>
        <translation>Questa finestra di dialogo consente di ottenere informazioni dettagliate su un file multimediale.</translation>
    </message>
    <message>
...
- Bitrate:			The video compression ratio (when available)</source>
        <translation>Questa zona contiene una scheda che elenca ogni traccia video presente nel file.
Per ogni traccia, le seguenti informazioni sono mostrate:
- #:			Numero brano
- Dimensione immagine:			Le dimensioni delle immagini della traccia video in numero di punti da numero di riga
- Formato immagine:		Le dimensioni delle immagini della traccia video in milioni di pixel
- Geometria Immagine:		La geometria immagine della traccia video (4:3, 16:9, ecc)
- Codec:			Il codec video utilizzato per la compressione immaginie
- Frame rate:			il numero di immagini al secondo del video
- Bitrate:			Il rapporto di compressione video (quando disponibile)</translation>
    </message>
    <message>
...
- Title:		A title (when available)</source>
        <translation>Questa zona contiene una tabella che elenca ogni traccia audio presente nel file.
Per ogni traccia, le seguenti informazioni sono mostrate:
- #:		Numero brano
- Lingua:		La lingua della traccia audio (in genere, macchine fotografiche e videocamere indicano ind per indefinita)
- Codec:		Il codec audio utilizzato per comprimere il suono
- Canali:		il numero di canali audio (1 = mono, 2 = stereo, ecc)
- Bitrate:		Il rapporto di compressione audio (quando disponibile)
- Frequenza:	La frequenza di campionamento utilizzata per la traccia audio
- Titolo:		Un titolo (ove disponibile)</translation>
    </message>
    <message>
...
- Duration:	The duration of the chapter</source>
        <translation>Questa zona viene visualizzata solo per i file che contengono i capitoli.Esso contiene una tabella che elenca tutti i capitoli presenti nel file.
Per ogni capitolo, vengono visualizzate la seguente informazione:
- #:		Numero capitolo
- Titolo:		Il titolo del capitolo
- Inizio:		La posizione temporale all&apos;inizio del capitolo
- End:		la posizione temporale alla fine del capitolo
- Durata:		La durata del capitolo</translation>
    </message>
    <message>
        <source>For an image:
...
- Composer:	The software with which the video was created</source>
        <translation>Per le immagini:
Visualizzare le informazioni EXIF forniti dalla fotocamera.
Questa zona può contenere diverse centinaia di linee secondo quello che la macchina fornisce.

Per un video:
Visualizza le informazioni sul video.
Sarà almeno mostrate le informazioni sulla durata del video, ma molte altre informazioni possono apparire secondo ciò che è disponibile nel file, ad esempio:
 Data_creazione:	Data e ora di creazione del video
- Titolo:		Campo titolo del TAG ID3v2 del video
- Artista:		Campo Artista del TAG ID3v2 del video
- Album:		Campo Albumdel TAG ID3v2 del video
- Data:		Campo data del TAG ID3v2 del video
- Commento:	Campo commento del TAG ID3v2 del video
- Composer:	Il software con il quale è stato creato il video</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;La zona tipo dispositivo permette di selezionare il tipo di apparecchiatura per essere mostrata nella lista.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Questo elenco mostra le categorie e i tipi di dispositivi presenti nel database.&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;:/img/db.png&quot;/&gt;
Dispositivi preceduti da questa icona sono definiti nel database predefinito.&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;:/img/db_update.png&quot;/&gt; I dispositivi preceduti da questa icona sono quelli che voi stessi definite, o quelli del database predefinito che è stato modificato.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Consente di selezionare la categoria in cui è classificata l&apos;attrezzatura&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <source>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Enter here the name of the device (free text entry field)&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</source>
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Inserisci qui il nome del dispositivo (campo libero di immissione testo)&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Questa finestra di dialogo consente di modificare il database dei profili attrezzature.&lt;/p&gt;&lt;p&gt;Il database è in realtà composto da due parti:&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;:/img/db.png&quot;/&gt; Il database predefinito (fornito con ffDiaporama). Questi dispositivi sono registrati nel file di configurazione globale di ffDiaporama.&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;:/img/db_update.png&quot;/&gt;I dispositivi che si modificano o si aggiungono. Questi sono registrati nel file di configurazione personale.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
</context>
<context>
...
Per favore seleziona un&apos;altro nome!</translation>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Gli stili esistenti vengono visualizzati con una icona che ha vari significati:&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;:/img/db.png&quot;/&gt; per uno stile standard&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;:/img/db_update.png&quot;/&gt; per uno stile standard modificato o per uno stile personalizzato&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <source>Allows to rename the selected style.</source>
        <translation>Permette di rinominare lo stile selezionato.</translation>
    </message>
    <message>
        <source>Allows to remove the personalized style.</source>
        <translation>Permette di rimuovere lo stile personalizzato.</translation>
    </message>
    <message>
...
Reset a standard style (that you modified) has its default values.</source>
        <translation>La finestra di dialogo Gestione stile consente diverse cose.
Rinomina lo stile esistente
Rimuovere lo stile personalizzato
Ripristinare uno stile standard (che si è modificato) ha i suoi valori di default.</translation>
    </message>
    <message>
...
It concerns as well the name of the style as the associated settings.</source>
        <translation>Permette di eliminare le personalizzazioni di uno stile standard e quindi di restituirlo ai valori predefiniti per questo stile.
Essa riguarda anche il nome dello stile come impostazioni associate.</translation>
    </message>
    <message>
...
Remark: This volume reduction is applied only for the selected slide.</source>
        <translation>Specifica che da ora in poi, il volume si riduce.
Questa opzione è particolarmente utile, per esempio, per ridurre il suono della musica durante la riproduzione di un video.
Nota: questa riduzione di volume viene applicata solo per la diapositiva selezionata.</translation>
    </message>
    <message>
        <source>Pauses the current play list.
Remark: This pause is applied only for the selected slide</source>
        <translation>Mette in pausa la playlist corrente.
Nota: Questa pausa viene applicata solo per la diapositiva selezionata</translation>
    </message>
    <message>
        <source>Adds a file to the playlist.
A file selection dialog appears, allowing you to select a file</source>
        <translation>Aggiunge un file alla playlist.
...
Sposta il file selezionato di un passo verso l&apos;alto.</translation>
    </message>
    <message>
        <source>Changes the order in which the music files will be played.
...
Questo volume è indipendente da eventuali riduzioni nel volume che si definisce nella parte superiore della finestra di dialogo</translation>
    ...
    <message utf8="true">
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;La finestra delle proprietà Musica consente di specificare la traccia musicale.&lt;/p&gt;&lt;p&gt;Il principale principio di  funzionamento per i brani musicali è che non si modificano le impostazioni, applicare le impostazioni precedenti prima di applicarle. Quindi, se:&lt;br/&gt;- Diapositiva 1 - Definisce un elenco di riproduzione&lt;br/&gt;- Diapositiva 2 -Non contiene impostazioni&lt;br/&gt;- Diapositiva 3 - Non contiene impostazioni&lt;br/&gt;- Diapositiva 4 - Definisce una lista di riproduzione&lt;br/&gt;- Diapositiva 5 - Non contiene impostazioni&lt;/p&gt;&lt;p&gt;Quindi:&lt;br/&gt;- Diapositiva 2 e 3 continuano a riprodurre la lista di riproduzione definita nella diapositiva 1&lt;br/&gt;- Diapositiva 5 continua a riprodurre la lista di riproduzione definita nella diapositiva 4&lt;/p&gt;&lt;p&gt;Le impostazioni disponibili per la traccia musicale:&lt;br/&gt;- Continuare con la riproduzione corrente: Riprodurre ancora la play list definita da una diapositiva precedente &lt;br/&gt; - Inizia una nuova playlist: Consente di creare una nuova playlist. Se un elenco definito in una diapositiva precedente, è ancora in gioco, ma viene fermato con un effetto fade-out (progressivo declino del volume fino a completare fermata).&lt;/p&gt;&lt;p&gt;Nota:&lt;/p&gt;&lt;p&gt;L&apos;effetto fade in / out e l&apos;aumento / diminuzione del volume si svolgono durante l&apos;inserimento transizioni diapositiva. Di conseguenza:&lt;br/&gt;- Esse durano per lo stesso tempo come la transizione.&lt;br/&gt;- Se una diapositiva ha una transizione in entrare insieme a &amp;quot;Nessuna transizione&amp;quot; l&apos;effetto sonoro non è progressiva ma instantaneo.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
</context>
<context>
...
This value is on 3 characters and follows the ISO 639 recommendation.</source>
        <translation>Definisce il valore del campo Lingua.
Questo valore viene utilizzato dai riproduttori per indicare in quale lingua è la traccia audio.
Questo valore è di 3 caratteri e segue le raccomandazione ISO 639.</translation>
    </message>
    <message>
        <source>Select the image format to be used to render the video from the displayed list.</source>
        <translation>Selezionare il formato immagine da utilizzare per il rendering del video dall&apos;elenco visualizzato.</translation>
    </message>
    <message>
        <source>Show the geometry of the project.</source>
        <translation>Mostra la geometria del progetto.</translation>
    </message>
    <message>
        <source>Select the audio codec to be used to render the video from the displayed list.</source>
        <translation>Selezionare il codec audio da utilizzare per il rendering del video dall&apos;elenco visualizzato.</translation>
    </message>
    <message>
        <source>Select the video codec to be used to render the video from the displayed list.</source>
        <translation>Selezionare il codec video da utilizzare per il rendering del video dall&apos;elenco visualizzato.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Selezionare il tipo di file da utilizzare per il rendering del video dall&apos;elenco visualizzato.</translation>
    </message>
    <message>
...
By checking the option All slides to render the video of the whole project.</source>
        <translation>Il rendering può essere fatto su tutto il progetto o solo su una parte.
Selezionando l&apos;opzione Tutte le diapositive per generare il video di tutto il progetto.</translation>
    </message>
    <message>
        <source>The rendering can be made on the whole project or only on a part.
By checking the option From and then entering the numbers of the start and end slides to generate a video of only a part of the project.</source>
        <translation>Il rendering può essere fatta su tutto il progetto o solo su una parte.
Selezionando l&apos;opzione Da e immettendo i numeri delle diapositive di inizio e fine per generare un video di una sola parte del progetto.</translation>
    </message>
    <message>
        <source>If this box is checked then the sound track will be included in the video.</source>
        <translation>Se questa casella è selezionata, la colonna sonora sarà inclusa nel video.</translation>
    </message>
    <message>
        <source>Click on this button to select graphically a file and a directory.</source>
        <translation>Fare clic su questo pulsante per selezionare graficamente un file e una directory.</translation>
    </message>
    <message>
        <source>This dialog allows you to render the project as a video file.</source>
        <translation>Questa finestra di dialogo consente di eseguire il rendering del progetto come un file video.</translation>
    </message>
    <message>
...
Note: the project properties are saved into the video as TAG (METADATA) which are used by a lot of indexing programs or by jukeboxes.</source>
        <translation>Questo pulsante consente di aprire la finestra delle proprietà del progetto.
...
This is valid as well for the movements of blocks as for the resizing (movements of the handles).</source>
        <translation>Questa finestra di dialogo consente di abilitare o disabilitare i righelli.
Quando si attiva un righello, il mouse viene attratto verso questo.
Questo è valido anche per i movimenti dei blocchi come per il ridimensionamento (movimenti delle maniglie).</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Questa finestra di dialogo consente di definire la durata dello scatto di una serie di diapositive.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Questa finestra di dialogo consente di definire la durata della transizione per una serie di diapositive.</translation>
    </message>
</context>
<context>
...
-LUMA transition: The animation is based on a luminance mask : the darker the points in the mask, the faster the corresponding points in the new slide replace those in the old slide.</source>
        <translation>Consente di selezionare una famiglia di transizioni.
- Nessuna transizione: La nuova diapositiva sostituisce immediatamente la vecchia. (Si noti che questo disattiva anche le transizioni di sfondo e fade sonoro così la playlist della nuova diapositiva sostituisce immediatamente quella vecchioa)
- Effetto Basic / Dissolvenza: La diapositiva compare gradualmente, con graduale aumento di opacità.
- Zoom: La nuova diapositiva appare sempre più grande mentre la vecchia diapositiva scompare con un effetto di dissolvenza.
- Slide: La nuova scivola sulla diapositiva vecchia che scompare con un effetto di dissolvenza.
-Spingere: La nuova diapositiva prende il posto della vecchia diapositiva spingendolo da parte.
-Transizione LUMA: L&apos;animazione si basa su una maschera di luminanza: più scuri i punti della maschera, più velocemente i punti corrispondenti nella nuova diapositiva sostituiscono quelli nella vecchia diapositiva.</translation>
    </message>
    <message>
        <source>Allows you to select a speed curve to apply to the transition.</source>
        <translation>Consente di selezionare una curva di velocità da applicare alla transizione.</translation>
    </message>
    <message>
...
The possible choices are of 0,5 seconds (very fast) to 10 seconds (very slow).</source>
        <translation>Consente di definire la durata dell&apos;animazione.
Le scelte possibili sono di 0,5 secondi (molto veloce) a 10 secondi (molto lento).</translation>
    </message>
    <message>
        <source>Allows you to select a transition.</source>
        <translation>Consente di selezionare una transizione.</translation>
    </message>
    <message>
        <source>This dialog allows you to define the entering transition for a slide.</source>
        <translation>Questa finestra di dialogo consente di definire la transizione di entrare in una diapositiva.</translation>
    </message>
</context>
<context>
...
Remark: numerous indexing systems or jukeboxes will read only the 1st line.</source>
        <translation>Un commento libero che può diffondersi su più linee.
Nota: numerosi sistemi di indicizzazione o jukebox leggono solo la prima riga.</translation>
    </message>
    <message>
...
Note: This field is only editable when the dialog box is opened for creating a new project. Subsequently, it is not possible to change this value.</source>
        <translation>Questo campo consente di selezionare la geometria da utilizzare per il progetto.
Nota: questo campo è editabile solo se la finestra di dialogo si apre per la creazione di un nuovo progetto. Successivamente, non è possibile modificare questo valore.</translation>
    </message>
    <message>
...
For more compatibility with indexing systems and jukeboxes, ffDiaporama does not include the whole video TAGs but is closer rather to the standard id3v2 than is the most used by these systems today. Furthermore, the video formats do not support every TAG in the same way.</source>
        <translation>Questa finestra di dialogo consente di definire le informazioni che qualifica il progetto.
...
Remark: Video formats do not support all the chapters in the same way.</source>
        <translation>I capitoli definiti nel progetto sono elencati per la consultazione. Per modificare i capitoli si utilizza la finestra modifica scorrevole.

Vengono visualizzati i seguenti campi:
- #: Il numero del capitolo
-Diapositiva: Numero diapositiva nel capitolo come è definito
-Titolo: Titolo Capitolo
-Inizio: posizione di inizio capitolo
-Fine: posizione di fine capitolo
-Durata: Durata capitolo
